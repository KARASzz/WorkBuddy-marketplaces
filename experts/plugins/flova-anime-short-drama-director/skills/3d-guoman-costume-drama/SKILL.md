---
name: flova-3d-guoman-costume-drama
display_name: Flova 3D 国漫古装精品短剧
display_name_en: Flova 3D Guoman Costume Drama
description: 通过 Flova MCP 按名称调用线上 Skill，围绕古装国漫、角色设定、场景与连续镜头推进视频项目。
description_zh: 通过 Flova MCP 按名称调用线上 Skill，围绕古装国漫、角色设定、场景与连续镜头推进视频项目。
...
本 Skill 是 WorkBuddy 到 Flova 线上创作 Skill 的场景适配层，重点处理古装国漫、角色设定、场景与连续镜头。具体 planner、分镜规则、模型 prompt 和媒体生成策略由线上 Flova Skill 负责，不在本包中复制。

线上 Skill 身份：

- 名称：3D国漫古装精品短剧
- 公开能力摘要：适用于将剧本拆解为3D古风风格短剧视频的全流程制作场景。画面风格统一锁定为3D质感，以Seedance 2.0为核心视频生成模型，配合GPT Image 2生成角色与场景设定图。
...
3. 典型阶段：剧情与角色 → 古装视觉规格 → 场景与道具 → 分镜 → 3D 镜头与对白 → 导出。实际阶段、强制确认和选项始终以上线 Skill 当前返回为准。
