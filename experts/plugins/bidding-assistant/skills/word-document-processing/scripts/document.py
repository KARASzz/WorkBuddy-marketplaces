...
# Add _shared to sys.path for ooxml toolkit (moved to shared dependency)
...
# Path to template files (moved to _shared/word-templates)
TEMPLATE_DIR = _SHARED_DIR / "word-templates"
...
class Document:
    ...
    def save(self, destination=None, validate=False) -> None:
        """
        ...
        Args:
            ...
            validate: If True, validates document before saving (default: False).
                      Note: Word-generated complex documents often have Schema
                      compatibility issues (non-standard but Word-tolerated formats).
                      Only enable validation when working with simple documents
                      or when you need strict OOXML compliance.
        """
