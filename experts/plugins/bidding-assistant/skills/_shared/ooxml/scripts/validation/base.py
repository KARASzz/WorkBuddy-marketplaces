...
class BaseSchemaValidator:
    ...
    def __init__(self, unpacked_dir, original_file, verbose=False):
        ...
        # Set schemas directory — prefer shared location, fallback to local
        _shared = Path(__file__).parent.parent.parent.parent.parent / "_shared" / "ooxml-schemas"
        _local = Path(__file__).parent.parent.parent / "schemas"
        self.schemas_dir = _shared if _shared.is_dir() else _local
